...
namespace SM
{
	...
	{
		0x00000003, 0x8FFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xF7FAFFFF,
		...
		0xFFFFFFFF, 0xFFFFFBFF, 0xFFFFFFEF, 0x7FFFFFFF, 0xFFFFF9FF,
		0xFFFFFFFF, 0x000FFFFF, 0xF98FFBFE, 0xFE07FFFC, 0x00000001,
		0x00000000, 0x7FFFFFFF, 0xFFFFFFFC, 0xFFFCFFFF, 0x7E7FF9E7,
		...
		0x0000EFC7, 0xFFFFFBFC, 0x000004FF, 0xBFFFFFC0, 0x0003FF80,
		0x800FF800, 0xFFFFFFFF, 0xF803FFFF, 0x00000000, 0x00000001,
		0x00000000, 0x8FFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xF7FAFFFF,
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFCDFFF, 0xFFFFFFFF,
		0xFDFFFFFF, 0xFFFFFFFF, 0xF7FFFFFF, 0x6FFFFFFF, 0xFF7FFFFF,
		0xDFFFFFFF, 0xFFFFDF7F, 0xFFFFFFFF, 0xFFFFFFE7, 0xFFFFFFFF,
		0xFFCFFFFF, 0x8FFFFF3F, 0xFFFFFFFF, 0xFFFE7FFF, 0xF8DFFFFF,
		0x7F01FFFF, 0xFFFE03FC, 0xFFFFFFEF, 0x7FFFFFFF, 0xFFFFF9FF,
		0x79FFFFFF, 0x000FFFFE, 0xF88FFBFE, 0xFE07FFFC, 0x00000001,
		0x00000000, 0x7FFFFFFF, 0xFFFFFFFC, 0xFFFCFFFF, 0x7E7FF9E7,
		0xFF9C7EF7, 0xFFFFFFFF, 0xFFFFFEFF, 0xF8E3E6FF, 0xFFFFFFFF,
		0xFEFFFFF7, 0xFF3CFFFF, 0x081FFFFF, 0xDFFFFFFC, 0xFFE7FFFF,
		0x39FFDFFF, 0xFFFFC090, 0xF9FFFFFF, 0xFFFFFFFF, 0xFE3FFFFF,
		0x1FF39FBF, 0xFFFFFE00, 0xBFFFFFDF, 0xFFFE07FF, 0xFFFFFFFF,
		0x0000EFC7, 0xFFFE03FC, 0x000004FF, 0xBFFFFFC0, 0x0003FF80,
		0x000FF800, 0xFFFFFFFE, 0xF803FFFF, 0x00000000, 0x00000001,
		0x00000000, 0x8FFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xF7FAFFFF,
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFCDFFF, 0xFFFFFFFF,
		0xFDFFFFFF, 0xFFFFFFFF, 0xF7FFFFFF, 0x6FFFFFFF, 0xFF7FFFFF,
		0xDFFFFFFF, 0xFFFFFF7F, 0xFFFFFFFF, 0xFFFFFFE7, 0xFFFFFFFF,
	...
	void GetPokedex(MenuEntry *entry)
	{
		if (!entry->IsActivated())
		{
			...
			if (KBValue == 0) // Seen
			{
				Process::CopyMemory((void *)(0x330D7DAC), Seen, 0x298);
				MessageBox("Operation has been completed!", DialogType::DialogOk).SetClear(ClearScreen::Both)();
			}
			
			if (KBValue == 1) // Caught
			{
				Process::CopyMemory((void *)(0x330D7D48), Caught, 0x60);
				MessageBox("Operation has been completed!", DialogType::DialogOk).SetClear(ClearScreen::Both)();
			}
		}
	}
	...
	void SetPokedex(MenuEntry *entry)
	{
		if (entry->Hotkeys[0].IsDown())
		{
			...
			if (READ16(0x330D780F, g_Data16) && (g_Data16 & ~0xFF0F) != 0x20)
			{
				READ8(0x330D780F, g_Data8);
				g_Data8 &= 0x0F;
				g_Data8 += 0x20;
				WRITE8(0x330D780F, g_Data8);
			}
			
			if (READ16(0x330D780F, g_Data16) && (g_Data16 & ~0xFF0F) == 0x20)
			{
				// Unlocks the other Pokedex elements once the Pokedex has been unlocked
				if (READ16(0x330D7818, g_Data16) && (g_Data16 & ~0xFFF0) != 0x07)
				{
					READ8(0x330D7818, g_Data8);
					g_Data8 &= 0xF0;
					g_Data8 += 0x07;
					WRITE8(0x330D7818, g_Data8);
				}
			}
		}
	}
