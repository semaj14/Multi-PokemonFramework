...
namespace XY
{
	...
	{
		216, 431, 442, 445, 446, 447, 450, 465, 466, 471, 628, 629,
		631, 632, 638, 641, 642, 643, 689, 695, 696, 697, 698, 700,
	...
	void SetPokedex(MenuEntry *entry)
	{
		...
		if (entry->Hotkeys[0].IsDown())
		{
			...
			{
				if (READ16(Address[1], g_Data16) && (g_Data16 & ~0xFFF0) != 0x07)
				{
